                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" name="kategori_produk" id="kategori_produk">
                                <option value="">Pilih kategori_produk</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" name="merk_produk" id="merk_produk">
                                ...
                                <option value="consina" {{ $data->merk_produk === 'consina' ? 'selected' : '' }}>
                                    Consina
                                </option>
                                <option value="forester" {{ $data->merk_produk === 'forester' ? 'selected' : '' }}>
                                    Forester
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" name="status_produk" id="status_produk">
                                ...
                                <option value="new arrival"
                                    {{ $data->status_produk === 'new arrival' ? 'selected' : '' }}>
                                    New Arrival</option>
