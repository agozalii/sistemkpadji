                            ...
                            <tr>
                                ...
                                <td>
                                    @php
                                        ...
                                        if ($promosi_use >= 0 && $promosi_use <= 5) {
                                            $rating = 1;
                                        } elseif ($promosi_use >= 6 && $promosi_use <= 10) {
                                            $rating = 2;
                                        } elseif ($promosi_use >= 11 && $promosi_use <= 15) {
                                            $rating = 3;
                                        } elseif ($promosi_use >= 16 && $promosi_use <= 20) {
                                            $rating = 4;
                                        } else {
                                            $rating = 5;
                                        }
                                ...
                                <td>
                                    @if ($d->promosi_use >= 0 && $d->promosi_use <= 5)
                                        <span class="badge bg-danger">Sangat Kurang Baik</span>
                                    @elseif ($d->promosi_use >= 6 && $d->promosi_use <= 10)
                                        <span class="badge bg-warning">Kurang Baik</span>
                                    @elseif ($d->promosi_use >= 11 && $d->promosi_use <= 15)
                                        <span class="badge bg-info">Cukup Baik</span>
                                    @elseif ($d->promosi_use >= 16 && $d->promosi_use <= 20)
