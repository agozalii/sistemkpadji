    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            ...
            {{-- <a class="navbar-brand" href="#">
                <img style="height: 24px; display: inline-block; vertical-align: middle; margin-top:-15px;" src="{{url('storage/img/consina.png')}}" alt="logo" />
                <img style="height: 20px; display: inline-block; vertical-align: middle; margin-top:-20px;" src="{{url('storage/img/forester.jpg')}}" alt="logo" />
                <div style="text-align: center; font-size: 15px; margin-top: -8px;">Forester Jakal</div>
            </a> --}}
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
                aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item ">
                        <a class="nav-link " style="color: #303030" href="{{ url('/') }}">Beranda</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('vip') }}">VIP</a>
                        </div>
                    </li>
                    <li class="nav-item ">
